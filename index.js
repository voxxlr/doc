...
V.Viewer = class
{
    constructor(attributes)
    {
        ...
        V.recvMessage("camera.project.get", (point) => 
        {
            let screen = V.camera.project(point);
                
            V.postMessage("camera.project.get", { pageX: screen.x*O.canvas.width, pageY: screen.y*O.canvas.height });
        });
...
V.Dataset.CLOUD = "cloud";
V.Dataset.MOSAIC = "map"
V.Dataset.WMTS = "wmts"
V.Dataset.PANORAMA = "panorama";
V.Dataset.MESH = "model";
V.Dataset.IMAGE = "image"
